    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-xl-3 col-sm-3">
                <div class="card">
                    <div class="card-header flex-wrap border-0 pb-0">
                        <div class="mr-3 mb-2">
                            <p class="fs-14 mb-1">Subscriptores Activos</p>
                            <span class="fs-24 text-black font-w600">{{ $totalSubscribers }}</span>
                        </div>
                        <span class="fs-12 mb-2">
                            ...
                            La cantidad de subscriptores activos en CloudTV.
                        </span>
                    </div>
            ...
            <div class="col-xl-3 col-sm-3">
                ...
                <div class="card-header flex-wrap border-0 pb-0">
                    <div class="mr-3 mb-2">
                    <p class="fs-14 mb-1">Subscriptores Nuevos</p>
                    <span class="fs-24 text-black font-w600">{{ $newSubscribers }}</span>
                    </div>
                    <span class="fs-12 mb-2">
                        <svg width="21" height="15" viewBox="0 0 21 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        La cantidad de subscriptores nuevos en CloudTV este mes.
                    </span>
                </div>
                <div class="card-body p-0">
            ...
            <div class="col-xl-3 col-sm-3">
                <div class="card">
                    <div class="card-header flex-wrap border-0 pb-0">
                        <div class="mr-3 mb-2">
                            <p class="fs-14 mb-1">Online Customers</p>
                            <span class="fs-24 text-black font-w600">{{ $online_customers }}</span>
                        </div>
                        <span class="fs-12 mb-2">
                            <svg width="21" height="15" viewBox="0 0 21 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M0.999939 13.5C1.91791 12.4157 4.89722 9.22772 6.49994 7.5L12.4999 10.5L19.4999 1.5" stroke="#2BC155" stroke-width="2"/>
            ...
            <div class="col-xl-3 col-sm-3">
                ...
                <div class="card-header flex-wrap border-0 pb-0">
                    <div class="mr-3 mb-2">
                    <p class="fs-14 mb-1">Peliculas</p>
                    <span class="fs-24 text-black font-w600">{{ $totalVideos }}</span>
                    </div>
                    <span class="fs-12 mb-2">
                        <svg width="21" height="15" viewBox="0 0 21 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M14.3514 7.5C15.9974 9.37169 19.0572 12.8253 20 14H1V1L8.18919 10.75L14.3514 7.5Z" fill="url(#paint0_linear1)"/>
                        ...
                        Cantidad de peliculas en CloudTV.
                    </span>
                </div>
                <div class="card-body p-0">
            ...
            <div class="col-xl-6">
                ...
                <div class="col-xl-12">
                    ...
                    <div class="card-body p-0">
                        <canvas id="widgetChart5" height="80"></canvas>
                    </div>
                    </div>
                </div>
                <div class="col-xl-12">
