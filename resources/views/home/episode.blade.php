...
@section('image')
    {{ URL::to('/') }}{{ ImageHandler::getImage($episode->poster, 'large') }}
@endsection
...
@section('content')
    ...
    <div id="video_bg" style="background-image:url('/images/{{ str_replace(' ', '%20', $episode->poster) }}')">
        <div id="video_bg_dim"
            @if($episode->access != 'guest' || ($episode->access != 'subscriber' && !\Auth::guest()) )
                class="darker"
            @endif
        ></div>
        <div class="container">            
            <div id="video_container">
                <video id="video_player" class="video-js vjs-default-skin" controls preload="auto" poster="<?= Config::get('site.uploads_url') . '/images/' . $episode->poster ?>" data-setup="{}" width="100%" style="width:100%;">
                    <source src="{{ $settings->server_link.'/'.$episode->serie_file_name }}" type='video/mp4'>
