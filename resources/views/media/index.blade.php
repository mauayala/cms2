...
@section('css')	
	<link rel="stylesheet" href="/admin/css/media/media.css" />
	<link rel="stylesheet" type="text/css" href="/admin/js/select2-x/select2.css">
	<link rel="stylesheet" href="/admin/css/media/dropzone.css" />
@stop
...
<div id="dropzone"></div>
	...
	<script src="/admin/js/select2-x/select2.min.js"></script>
	<script src="/admin/js/media/dropzone.js"></script>
	<script src="/admin/js/media/media.js"></script>
