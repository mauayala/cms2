...
@section('content')
    ...
    <div id="admin-container">
        ...
        <div class="admin-section-title">
            <h3><i class="entypo-plus"></i> Add New Season</h3>
        </div>
        <div class="clear"></div>
            ...
            <div class="panel-body" style="display: block;">
                <form class="form-inline" id="omdb-search">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="season_number" id="season_number" placeholder="Season number" value="" />
                    </div>
                    <div class="form-group">
        ...
        <form method="POST" action="{{ route('dashboard.series.seasons.store', ['series' => $series->id]) }}" accept-charset="UTF-8" file="1" enctype="multipart/form-data">
            @csrf
            <div class="panel panel-primary" data-collapsed="0"> <div class="panel-heading">
                ...
                <div class="panel-body" style="display: block;">
                    ...
                    <div class="col-md-4" style="padding-left: 0;">
                        <div class="form-group">
                            <input type="text" class="form-control" name="runtime" id="runtime" placeholder="Runtime (in seconds)" value="@if(!empty($series->runtime)){{ $series->runtime }}@endif" />
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
            ...
            <input type="submit" value="Add New Season" class="btn btn-success pull-right" />
